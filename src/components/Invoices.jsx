...
//   const [dateDownloadAnchorEl, setDateDownloadAnchorEl] = useState(null);
...
//   const handleDateDownloadMenuOpen = (event) => {
//     setDateDownloadAnchorEl(event.currentTarget);
//   };

//   const handleDateDownloadMenuClose = () => {
//     setDateDownloadAnchorEl(null);
//   };
...
//   const exportToExcel = (data, filename = 'invoices.xlsx') => {
...
//   const exportByMonth = (months) => {
//     const cutoff = new Date();
//     cutoff.setMonth(cutoff.getMonth() - months);
//     const filtered = invoices.filter(inv => new Date(inv.date) >= cutoff).map(inv => ({
//       Client: inv.client || '-',
//       Date: new Date(inv.date).toLocaleDateString(),
//       'Balance Due': inv.balanceDue,
//     }));
//     exportToExcel(filtered, `invoices_last_${months}_months.xlsx`);
//     handleDateDownloadMenuClose();
//   };
...
//             Download All
//           </Button>
//           <Button variant="outlined" onClick={handleDateDownloadMenuOpen} sx={{ mr: 2 }}>
//             Download via Date
//           </Button>
...
//           <MenuItem onClick={exportAllToExcel}>Download as Excel</MenuItem>
//         </Menu>
//         <Menu
//           anchorEl={dateDownloadAnchorEl}
//           open={Boolean(dateDownloadAnchorEl)}
//           onClose={handleDateDownloadMenuClose}
//         >
//           <MenuItem onClick={() => exportByMonth(1)}>Last 1 Month</MenuItem>
//           <MenuItem onClick={() => exportByMonth(2)}>Last 2 Months</MenuItem>
//           <MenuItem onClick={() => exportByMonth(3)}>Last 3 Months</MenuItem>
//         </Menu>
//       </Box>
